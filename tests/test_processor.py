...
class _StubTokenizer:
    """Minimal tokenizer interface for BatchProcessor tests."""

    def encode(self, events: pl.DataFrame) -> list[int]:
        return [int(v) for v in events.get_column("value").to_list()]
...
@pytest.fixture
def tokenizer():
    """Create a tokenizer-like stub for processor integration tests."""
